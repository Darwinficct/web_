    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Abogados</div>
            </a>
            ...
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.ciudades') }}">
                    {{-- <i class="fas fa-fw fa-cog"></i> --}}
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Gestionar Ciudades</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.juzgados') }}">
                    {{-- <i class="fas fa-fw fa-cog"></i> --}}
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Gestionar Juzgados</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.casos') }}">
                    {{-- <i class="fas fa-fw fa-cog"></i> --}}
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Gestionar Casos</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ asset('AdminTemplate/img/undraw_profile.svg')}}">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Darwin Acosta Garcia 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
