        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="{{route('admin.login')}}">Abogados</a>
                    </li>
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <form action="{{ route('index') }}" method="GET">
                    ...
                    <br>
                    <div class="form-group">
                        <select class="form-select" name="juzgado" aria-label="Default select example">
                            @if (!is_null($juzgados))
                    ...
                    <br>
                    <div class="form-group">
                        <select class="form-select" name="caso" aria-label="Default select example">
                            @if (!is_null($casos))
                ...
                @if (!is_null($pruebas))
                    @foreach ($pruebas as $prueba)
                        ...
                        <div class="post-preview">
                            <a href="{{route('expedientes',$prueba->id)}}">
                                <h2 class="post-title">{{'Prueba: '.$prueba->nombre}}
                                </h2>
                                <h3 class="post-subtitle">{{$prueba->descripcion}}</h3>
                            </a>
                        </div>
                        <!-- Divider-->
                        <hr class="my-4" />
