...
<head>
    ...
    <title>Menu Principal Administrator</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Procuradores</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('usuario.pruebas')}}">
                   <i class="fas fa-fw fa-cog"></i>
                    <span>Gestionar Pruebas</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{route('usuario.expedientes')}}">
                   <i class="fas fa-fw fa-cog"></i>
                    <span>Gestionar Expedientes</span></a>
            </li>
